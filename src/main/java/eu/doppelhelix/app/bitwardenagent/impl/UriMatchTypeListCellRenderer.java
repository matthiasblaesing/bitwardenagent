...
public class UriMatchTypeListCellRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        if(value instanceof UriMatchType umt) {
            return super.getListCellRendererComponent(list, RESOURCE_BUNDLE.getString("uriMatchType." + umt.name()), index, isSelected, cellHasFocus);
        } else {
