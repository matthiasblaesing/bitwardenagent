...
public class LinkedIdListCellRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        if(value instanceof LinkedId li) {
            return super.getListCellRendererComponent(list, RESOURCE_BUNDLE.getString("linkedId." + li.name()), index, isSelected, cellHasFocus);
        } else {
