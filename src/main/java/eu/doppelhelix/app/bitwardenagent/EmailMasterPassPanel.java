...
public class EmailMasterPassPanel extends javax.swing.JPanel {

    private static final Logger LOG = System.getLogger(EmailMasterPassPanel.class.getName());
    ...
    private void initComponents() {
        ...
        emailLabel.setText(bundle.getString("emailLabel")); // NOI18N
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        add(emailInput, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
